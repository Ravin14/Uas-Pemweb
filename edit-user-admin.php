...
if (isset($_POST['update'])) {
    ...
    $result = mysqli_query($koneksi, "UPDATE user SET namaLengkap='$varNama', tempatLahir='$varTempatLahir', tanggalLahir='$varTanggalLahir', alamat='$varAlamat', email='$varEmail', noTelepon='$varTelepon', userDesc='$varDesc' WHERE id_pelanggan= '$idInput'");

    header("location:dashboardAdmin.php");
}

$result = mysqli_query($koneksi, "SELECT * FROM user WHERE id_pelanggan = '$idInput'");
while ($item = mysqli_fetch_array($result)) {
    $showUname = $item['username'];
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input disabled type="text" class="form-control" value="<?= $showUname ?>">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
