			...
			<div id="content" class="col-md-12 col-sm-12 col-xs-12">
				<div class="blog-detail clearfix">
					<div class="article-image banners" style="display: flex; justify-content :center; margin-top: 30px;">
						<img src="image/2.jpg" style="width: 60%;" alt="Baby Came Back! Missed Out? Grab Your">
					</div>
					<hr>
					<hr>
					<div class="content clearfix">
						<h1>Mengulik Potensi Wisata Kota Solo dalam Mewujudkan Kemandirian Ekonomi</h1>
						...
						<p>Setelah mengenal lebih dekat mengenai Kota Surakarta dari beberapa artikel yang sudah dimuat, dilihat dari sejarah, julukan, potensi budaya, dan peninggalan sejarahnya. Pembahasan kali ini masih berkaitan dengan potensi yang dimiliki oleh kota ini yaitu potensi wisata.
						Beragam potensi yang dimiliki Kota Surakarta sebenarnya menjadi salah satu langkah yang cukup baik untuk meningkatkan kemandirian ekonomi daerah, salah satunya adalah melalui sektor pariwisata.
						<br><br>Sektor pariwisata merupakan sektor yang potensial untuk dikembangkan sebagai salah satu sumber pendapatan daerah. Program pengembangan dan pendayagunaan sumber daya dan potensi pariwisata daerah diharapkan memberikan sumbangan bagi pembangunan ekonomi. Kedatangan wisatawan pada suatu Daerah Tujuan Wisata (DTW) telah memberikan kemakmuran dan kesejahteraan bagi penduduk setempat.
						Contohnya saja salah satu potensi wisata yang terkenal yaitu wisata budaya di Keraton Surakarta. Saat malam hari, di sekitar Keraton Surakarta atau tepatnya di alun-alun kidul terdapat jejeran kuliner yang bebas dikunjungi oleh wisatawan. Secara tidak langsung, 
